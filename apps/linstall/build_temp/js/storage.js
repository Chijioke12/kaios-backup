...
var StorageAPI = {
   ...
   */
  getStorages: function getStorages(type) {
    type = type || 'sdcard';
    try {
   ...
   */
  enumerateFiles: function enumerateFiles(options) {
    options = options || {};
   ...
   * @returns {Promise<File>}
   */
  getFile: function getFile(name, type) {
   ...
   * @returns {Promise<File>}
   */
  addFile: function addFile(blob, name, type) {
    var storage = this.getStorage(type || 'sdcard');
    return new Promise(function (resolve, reject) {
      if (!storage) return reject(new Error('Storage not found'));
   ...
   */
  deleteFile: function deleteFile(name, type) {
    var storage = this.getStorage(type || 'sdcard');
    return new Promise(function (resolve, reject) {
      if (!storage) return reject(new Error('Storage not found'));
   ...
   */
  getFreeSpace: function getFreeSpace(type) {
    var storage = this.getStorage(type || 'sdcard');
    return new Promise(function (resolve, reject) {
      if (!storage) return reject(new Error('Storage not found'));
